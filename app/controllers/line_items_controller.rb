class LineItemsController < ApplicationController
  ...
  def create
    ...
    if @line_item.save
      respond_to do |format|
        ...
        format.turbo_stream { flash[:notice] = "Item was successfully created." }
      end
    else
  ...
  def update
    if @line_item.update(line_item_params)
      respond_to do |format|
        ...
        format.turbo_stream { flash[:notice] = "Item was successfully updated." }
      end
    else
  ...
  def destroy
    @line_item.destroy
    respond_to do |format|
      format.html {  redirect_to quote_path(@quote), notice: "Item was deleted successfully." }
      format.turbo_stream { flash[:notice] = "Item was deleted successfully." }
    end
  end
